  ...
  return (
    <section className="pt-28 pb-16">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center">
        <motion.div initial={{ x:-30, opacity:0 }} animate={{ x:0, opacity:1 }} transition={{ duration:.7 }}>
          ...
          <h2 className="mt-8 text-3xl md:text-4xl font-extrabold text-gray-100 leading-tight">
            Soluciones integrales en mantenimiento y automatización industrial.
          </h2>
          <p className="mt-4 text-gray-400">
            Especialistas en maquinaria de inyección de plásticos — mantenimiento preventivo, correctivo y predictivo; instalación y puesta en marcha.
          </p>

          <div className="mt-6 flex gap-3">
            <a href="#contacto" className="bg-desoBlue px-5 py-3 rounded-2xl font-semibold text-black">Contactar ingeniero</a>
            <a href="#servicios" className="border border-gray-700 px-5 py-3 rounded-2xl text-gray-300 hover:text-white">Cotizar mantenimiento</a>
          </div>
        </motion.div>

        <motion.div initial={{ x:30, opacity:0 }} animate={{ x:0, opacity:1 }} transition={{ duration:.7 }} className="rounded-2xl p-6 bg-gradient-to-b from-gray-900 to-black border border-gray-800">
